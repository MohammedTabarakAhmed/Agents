...
class GraphBuilder:
    def __init__(self,llm): #Initialize this newly created object.
        self.llm=llm
    ...
    def build_topic_graph(self):
        ...
        ##nodes
        self.graph.add_node("title_creation",self.blog_node_obj.title_generation)
    ...
    def build_language_graph(self):
        ...
        self.graph.add_node("content_generation",self.blog_node_obj.content_generation)
        self.graph.add_node("hindi_translation",lambda state: self.blog_node_obj.translation({**state, "current_language": "hindi"})) #---->**state = unpack the dictionary----->If: state = {"topic": "AI", "content": "Hello"} --->then: {**state, "current_language": "hindi"} --->becomes: {"topic": "AI","content": "Hello","current_language": "hindi"}
